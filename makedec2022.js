...
/*
  ...
  ased on the above temperature and rain.
...
if (temperature >= 80 && rain) {
  console.log("You should wear and T-shirt and don't forget to bring an umbrella");
} else if(temperature <= 80 && temperature >= 60 && rain) {
  console.log("You should wear a rain-jacket out there, and don't forget to take your umbrella");
} else if(temperature <= 60 && rain) {
  console.log("You should wear a jacket and carry an umbrella before you go outside");
} else if(temperature >= 80 && rain == false) {
  console.log("Pretty warm out there, just bring a T-shirt, some shorts, and a pair of sandals");
} else if(temperature <= 80 && temperature >= 60 && rain == false) {
  console.log("Bring T-shirt and pants, weather is nice")
} else if(temperature <= 60 && rain == false) {
  console.log("It's too cold out there bring 4 layers and heavy pants before you go out!")
}
